...
This mod is meant to make human-made (and semi-automated) tases easier to make. It allows you to force RNG events (including natural and pseudonatural GC effects and their timers, DEoRL forcing, and cookie storm optimizations), automate certain actions and slow down the game (from code with permission from the dev of PforPause.js)
